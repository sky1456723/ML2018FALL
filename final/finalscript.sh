...
wget -O model_7 https://www.dropbox.com/s/h01bhoc2sp0ljcu/test_chexnet_params_1.pkl?dl=0
wget -O model_8 https://www.dropbox.com/s/ggsyvg1rummjz2s/test1.model?dl=0
wget -O model_9 https://www.dropbox.com/s/1i5ocs7pvf96fbh/test4_ori?dl=0
wget -O model_10 https://www.dropbox.com/s/oc9tq0gwiq6zhth/test5?dl=0
wget -O model_11 https://www.dropbox.com/s/z0dcz58w38g44nx/default_2?dl=0
for i in {1..11}
do
	python3 test_combine_model.py $model_$i $model_$i.csv
done
python3 test_combine_model.py ./model/Combine_more_aug.pkl  $model_12.csv
python3 test_combine_model.py ./model/test_combine.pkl  $model_13.csv
python3 ensemble.py 